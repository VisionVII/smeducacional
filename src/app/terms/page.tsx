        ...
        <section className="py-16 container mx-auto px-4">
          <Card className="max-w-4xl mx-auto p-8 md:p-12">
            <div className="prose max-w-none">
              ...
              <p>
                Todo o conteúdo da plataforma, incluindo textos, vídeos, imagens
                e materiais didáticos, é protegido por direitos autorais e
                pertence à SM Educacional ou seus licenciadores.
              </p>
              ...
              <ul>
                ...
                <li>
                  Reembolso integral se menos de 20% do curso foi acessado
                </li>
              ...
              <p>
                Reservamo-nos o direito de modificar ou descontinuar a
                plataforma ou qualquer curso a qualquer momento, com ou sem
                aviso prévio.
              </p>

              <h2>9. Limitação de Responsabilidade</h2>
              <p>
                A SM Educacional não será responsável por quaisquer danos
