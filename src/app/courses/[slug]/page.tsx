            ...
            <div className="lg:col-span-2">
              ...
              {course.requirements && (
                <Card className="mb-8">
                  ...
                  <CardContent>
                    <p className="text-gray-600 dark:text-gray-400">{course.requirements}</p>
                  </CardContent>
                </Card>
              )}
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    {course.modules.length} módulos • {totalLessons} aulas • {Math.floor(totalDuration / 60)}h {totalDuration % 60}min
                  </CardDescription>
                </CardHeader>
                <CardContent>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="pt-4 border-t space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-gray-600 dark:text-gray-400">Módulos</span>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-semibold">{Math.floor(totalDuration / 60)}h</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-gray-600 dark:text-gray-400">Nível</span>
                      <span className="font-semibold">{course.level || 'Todos'}</span>
                    </div>
                  </div>
