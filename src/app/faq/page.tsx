  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "Você pode entrar em contato através do email suporte@smeducacional.com ou pelo sistema de mensagens dentro da plataforma. Nosso time responde em até 24 horas úteis.",
      },
    ],
  },
];
      ...
      <Card className="mt-12">
        ...
        <CardContent>
          <div className="space-y-2 text-sm">
            <p>
              <strong>Email:</strong> suporte@smeducacional.com
            </p>
            <p>
