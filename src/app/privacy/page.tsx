        ...
        <section className="py-16 container mx-auto px-4">
          <Card className="max-w-4xl mx-auto p-8 md:p-12">
            <div className="prose max-w-none">
              <h2>1. Introdução</h2>
              <p>
                A SM Educacional (&ldquo;nós&rdquo;, &ldquo;nosso&rdquo; ou
                &ldquo;nos&rdquo;) está comprometida em proteger sua
              ...
              <ul>
                <li>
                  <strong>Professores:</strong> Seu nome e progresso nos cursos
              ...
              <p>
                ...
                experiência. Você pode controlar cookies através das
              ...
              <p>
                ...
                nossos serviços e cumprir obrigações legais. Após a exclusão da
                conta, alguns dados podem ser mantidos por até 5 anos para fins
                contábeis e legais.
              </p>

              <h2>9. Dados de Menores</h2>
              <p>
                Nossa plataforma não é direcionada a menores de 18 anos. Se você
                é responsável legal e acredita que seu filho nos forneceu
              ...
              <h2>11. Contato</h2>
              <p>
                Para questões sobre privacidade ou exercer seus direitos, entre
                em contato:
              </p>
              <ul>
              ...
              <p>
                Esta Política está em conformidade com a Lei nº 13.709/2018
                (LGPD). Nosso DPO (Encarregado de Proteção de Dados) pode ser
                contatado em: dpo@smeducacional.com
              </p>
            </div>
          </Card>
        </section>
